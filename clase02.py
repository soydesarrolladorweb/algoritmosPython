# Determinar si un estudiante es apto para el subsidio del gobierno para acceder a una educacion escolar.
# No puede estar a mas de 40 km alrededor de la escuela.
# Debe tener mas de 2 hermanos
# El ingreso familiar debe ser menos de 1000 dolares

distancia = (input("A que distancia vive de la escuela: (Km)"))
distancia = float(distancia)

if distancia <= 40:
    #it is posible
    numero_de_hermanos = input("Ingrese el numero de hermanos:  ")
    numero_de_hermanos = float(numero_de_hermanos)
